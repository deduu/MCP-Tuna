...
async def main():
    ...
    print(f"  Epochs:          1")
    print(f"  LoRA r=8, alpha=16")
    print(f"  Batch size:      1 × 4 grad_accum")
    print(f"  Max seq length:  512 (reduced for 4 GB VRAM)")
    print(f"  Completion-only: False (TRL formatting_func compat)")
    print(f"  LR scheduler:    cosine, warmup=0.03")
